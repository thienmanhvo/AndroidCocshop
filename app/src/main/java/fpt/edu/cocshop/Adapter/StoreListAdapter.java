...
public class StoreListAdapter extends RecyclerView.Adapter<StoreListAdapter.ViewHolderItem> {

    private List<Store> mStoreList;
    private Context mContext;
    private StoreListAdapter.OnItemOrderClickListener mOnStoreListClickListener;

    public void setmOnStoreListClickListener(OnItemOrderClickListener mOnStoreListClickListener) {
        this.mOnStoreListClickListener = mOnStoreListClickListener;
    }
    ...
    public StoreListAdapter(Context mContext, List<Store> mStoreList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StoreListAdapter.ViewHolderItem holder, int position) {
        holder.bind(mStoreList.get(position));
        holder.mLlStoreList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnStoreListClickListener.onClickStoreItem(mStoreList.get(position));
            }
        });
    }
